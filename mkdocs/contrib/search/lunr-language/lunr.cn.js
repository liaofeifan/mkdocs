...
(function(root, factory) {
  ...
  return function(lunr) {
    ...
    lunr.cn.wordCharacters = "一二三四五六七八九十百千万亿兆a-zA-Zａ-ｚＡ-Ｚ0-9０-９";
    ...
    lunr.Pipeline.registerFunction(lunr.cn.stopWordFilter, 'stopWordFilter-ja');

    // alias ja => jp for backward-compatibility.
    // jp is the country code, while ja is the language code
    // a new lunr.cn.js has been created, but in order to
    // keep the backward compatibility, we'll leave the lunr.zh.js
    // here for a while, and just make it use the new lunr.cn.js
    lunr.zh = lunr.cn;
